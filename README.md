...
```
cd existing_repo
git remote add origin https://gitlab.com/Akbravo123456/ai-companion.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Akbravo123456/ai-companion/-/settings/integrations)
